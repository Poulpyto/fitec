 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:8585/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://webservice/", "BanqueWS");
