...
/**
 * Classe domaine metier: Carte Bancaire Visa Electron
 ...
 *
 */
public class VisaElectron extends CarteBanquaire {
	 ...
	 */
	public VisaElectron(String numero, boolean bloquee, CompteCourant compteAssocie) {
